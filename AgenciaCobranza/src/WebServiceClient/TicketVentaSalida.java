...
public class TicketVentaSalida  implements java.io.Serializable {
    ...
    private WebServiceClient.Mensaje mensaje;
    ...
    public TicketVentaSalida(
           float impTotal,
           WebServiceClient.Mensaje mensaje,
           int ticketNro) {
     ...
     * @return mensaje
     */
    public WebServiceClient.Mensaje getMensaje() {
        return mensaje;
    }
     ...
     * @param mensaje
     */
    public void setMensaje(WebServiceClient.Mensaje mensaje) {
        this.mensaje = mensaje;
    }
